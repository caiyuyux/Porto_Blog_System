...
//				}
            ...
            if (hasfilter || filter == "*") {
                ...
                setTimeout(function () {
                    ...
                    if (opt.filterChangeAnimation == "fade") {
                        ...
                        punchgs.TweenLite.to(ent.find('.mega-entry-innerwrap'), opt.filterChangeSpeed / 1000, {
                            scale: 1,
                            opacity: 1,
                            transformPerspecitve: 300,
                            rotationX: 0,
    ...
    function preparingLazyLoad(container) {
        ...
        container.find('>.mega-entry').each(function (i) {
            ...
            if (opt.filterChangeAnimation == "fade")
                ...
                punchgs.TweenLite.set(ent.find('.mega-entry-innerwrap'), {
                    scale: 1,
                    opacity: 0,
                    transformOrigin: torig,
                    rotationX: 90,
    ...
    function reOrder(container, deep) {
        ...
        if (next_layout == 11 || next_layout == 12 || next_layout == 13 || next_layout == 15 || next_layout == 16 || next_layout == 17)
            ...
            else if (cw < 720) element_amount = 3;
